<template>
  <div id="app">
    <div class="container">
      ...
      <hex-message v-if="messages.length" :dismiss="resetMessages" class="v-info">
        <ul>
      ...
      <hex-message dismissible ref="invisible" :visible="false" class="v-primary text-white">
